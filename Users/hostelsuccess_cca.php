 ...
 <?php
  ...
  if($order_status=="Success")
  {
    ...
    {   
      ...
      {
        echo "<br><br><center><b>Hostel Fee Already Submitted!";
        exit();
      }

      $ssql="UPDATE `hostel_fees_temp` SET `TxnStatus`='$order_status',`PGTxnId`='$pgtxnno' where `TxnId`='$txnid'";
      ...
      echo "</head><body>";
      echo "<script>toastr.success('Your Hostel Fees has been Submitted Successfully', 'Success'); setTimeout(function() { window.location.href='MyFees.php'; }, 1500);</script>";
      echo "</body></html>"; 
