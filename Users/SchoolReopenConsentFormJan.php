...
$rsChk=mysqli_query($Con, "select * from `SchoolReopenConsentJan` where `EmpId`='$EmployeeId'");
	...
	if($_REQUEST["isSubmit"]=="yes")
		{
              ...
              if($value['name'] != ''){
                ...
                mysqli_query($Con, "INSERT INTO `SchoolReopenConsentJan`(`EmpId`, `EmpName`, `EmpType`, `EmpDesig`,`Consent`,`Reason`,`attachment`) VALUES('$sadmission','$sname','$sclass','$srollno','$Consent','$Description','$img_name')");
...
<tr>
<td align="center">
<u><b>School Reopen Consent Form </b></u></td>
</tr>
<tr>
<td align="center">
<p align="left">&nbsp;</p>
...
<form name="frmUpload" id="frmUpload" method="post" action="SchoolReopenConsentFormJan.php" enctype="multipart/form-data">
...
while($row1 = mysqli_fetch_row($rsEmpDetail))
{
	...
	<tr>
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px" width="14%"><font face="Cambria">
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px" width="11%"><font face="Cambria">
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px" width="25%"><font face="Cambria">
 ...
 ?>
	...
	<tr>
		...
		Offline school will resume for classes IX to XII from February 1,2022. 
		If you wish to send your ward to school, kindly indicate your consent on 
		the student portal by 9:00 pm January 30, 2022. <br>
		Kindly ensure that your ward is filling the health declaration 
		everyday indicating his / her health status and that of the 
		family. <br>
		Also, the child will need to submit an RTPCR ,of maximum 72 hrs prior to 
		Feb1, 2022 on the student portal before joining school</p>
		<p style="text-align: left"><b>Principal</b></td>
		<td class="style2" colspan="2" width="16%">
	...
	<tr style="display:none" id="abc">
		   ...
		   <td align="center" style="border-style: solid; border-width: 1px" width="11%">
			<p><b><font face="Cambria">Attachment (RTPCR ) (file size Max. 1MB) </font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="14%"><font face="Cambria">
