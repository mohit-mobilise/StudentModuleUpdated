...
if($_REQUEST['']){
    ...
    $img_name = $pic_name . "_" . $t . "." . $imageFileType;
    $target_file = $target_dir . $img_name;
    if ($imageFileType == 'jpg' or $imageFileType == 'jpeg' or $imageFileType == 'JPG') {
        if (file_exists($img_name)) {
            return array("status" => false, 'info' => "Error: File already exists,  Please upload another attachments ");
        } //filie exists close
        else {
            $uploaded = move_uploaded_file($image["tmp_name"], $target_file);
            if ($uploaded) {
                return array("status" => true, 'info' => $img_name);
            } else {
                return array("status" => false, 'info' => 'Error: uploading image in directory');
            }
        }
    } else {
        return array("status" => false, 'info' => 'Error: This is not a valid image format please only upload,.images like jpg, JPG, jpeg other ' . $imageFileType);
    }
exit;    
}
...
{
	echo ("<br><br><center><b>Due to security reason or network issues your session has expired!<br>Click <a href='http://nkbpsdsis.mobilisesis.co.in/Users/index.php'>here</a> to login again");
	exit();
}
...
<!--<div class="page-content-wrapper" style="background-color: #f7f7f7 !important;">-->
            <div class="page-content">
                ...
                <div class="container-fluid" style="background-color:white;padding:8px">
                    ...
                    <section>
                        <div class="col-md-12 m-t-1">
                            <div class="row m-0">
                                <div class="col-md-12 p-0"><img src="img/emp-banner.png" width="100%"
                                        class="border-up img-fluid"></div>
                                <div class="col-md-12 bg-white border-down">
            ...
            ?>
                                            ...
                                            <div class="profilepic__content"><span><i aria-hidden="true"
                                                        class="fa fa-camera fa-lg cameraimg" onclick="document.getElementById('profileimg').click()"></i></span><input type="file"
                                                    accept="image/*" class="d-none" id='profileimg'></div>
                                        </div>
                                        <div class="col-md-4">
