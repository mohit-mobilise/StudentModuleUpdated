...
if ($txnid != "")
{
		...
		while($row = mysqli_fetch_row($rsRcpt))
				{
					$newsrno=$row[0];
		...
		while($rows = mysqli_fetch_row($rsStudentDetail))
		{
			...
			$ssql2="INSERT INTO `fees_student` (`sadmission`,`class`,`Name`,`feeshead`,`amount`,`financialyear`,`FeesType`) VALUES ('$sadmission','$sclass','$sname','$FeeHead','$amountpaid','$FinancialYear','Hostel')";
