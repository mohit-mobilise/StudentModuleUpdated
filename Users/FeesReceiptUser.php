...
if($txnstatus=="Success")
	{
		...
		while($rows = mysqli_fetch_row($rsSchoolDetail))
		{
			...
			$currentYear=date("Y");
				...
				$ssql="INSERT INTO `fees` (`sadmission` ,`sname` ,`sclass`,`srollno`,`fees_amount`,`AdjustedLateFee`,`DiscountAmount`,`amountpaid`,`BalanceAmt`,`quarter`,`date`,`FinancialYear`,`status`,`receipt`,`finalamount`,`ReceiptFileName`,`PaymentMode`,`chequeno`,`bankname`,`branch`,`cheque_date`,`cheque_status`,`DebitHead`,`TxnAmount`,`TxnId`,`PGTxnId`,`TxnStatus`,`FeesType`) select `sadmission` ,`sname` ,`sclass`,`srollno`,`fees_amount`,`AdjustedLateFee`,`DiscountAmount`,`amountpaid`,`BalanceAmt`,`quarter`,`date`,`FinancialYear`,`status`,`receipt`,`finalamount`,`ReceiptFileName`,`PaymentMode`,`chequeno`,`bankname`,`branch`,`cheque_date`,`cheque_status`,`DebitHead`,`TxnAmount`,`TxnId`,`PGTxnId`,`TxnStatus`,'Regular' from `fees_temp` where `TxnId`='$txnid'";
				mysqli_query($Con, $ssql) or die(mysqli_error($Con));
