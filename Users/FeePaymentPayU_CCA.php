	...
	for ($i=0; $i < sizeof($_POST['mycheckbox']); $i++) 
  {
	  ...
	  while ($rsfeehead = mysqli_fetch_assoc($sqlfeehead)) 
    {
      ...
      if ($balance1 > 0 && $amount != 0) 
      {
        ...
        mysqli_query($Con, "INSERT INTO `fees_transaction_temp`(`sadmission`, `receipt_no`, `head_id`, `cr_amnt`, `Month`, `fy`, `InputSource`, `created_by`,`TxnId`) VALUES ('$sadmission','$receipt','$head_id','$cr_amnt1','$month_name1','$currentyear','Internal','$logged_user','$merchantTxnId')");
      }
