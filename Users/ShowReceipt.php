	  ...
	  if($refURL == $baseURL1)
        {
			...
			Receipt for Session : <?php echo $FinancialYear; ?>(Quarter:<?php echo $quarter;?>)</font></td>
    ...
    <?php
        ...
        else
        {
            ?>
            	...
            	<font face="Cambria" style="font-size: 10pt; font-weight:700">Fees 
			Receipt for Session : <?php echo $FinancialYear; ?>(Quarter:<?php echo $quarter;?>)(Month: <?php echo $FeeMonth;?>)</font></td>
    <?php        
        }
