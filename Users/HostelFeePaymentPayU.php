...
$MERCHANT_KEY = $hostel_app_merchant_key; //Please change this value with live key for production
$hash_string = '';
// Merchant Salt as provided by Payu
// $SALT = "oTTleS1b"; //Please change this value with live salt for production    -----old one------
$SALT = $hostel_app_salt_key;
		 ...
		 while ($rsfeehead = mysqli_fetch_assoc($sqlfeehead)) 
        {
            ...
            $balance1 = $dr_amnt1 - $cr_amnt1;
			 if ($balance1 > 0 && $amount != 0) 
             {
                ...
                mysqli_query($Con, "INSERT INTO `hostel_fees_transaction_temp`(`sadmission`, `receipt_no`, `head_id`, `cr_amnt`, `Month`, `fy`, `InputSource`, `created_by`,`TxnId`) VALUES ('$sadmission','$receipt','$head_id','$cr_amnt1','$month_name1','$currentyear','Internal','$logged_user','$txnid')");
...
&quot;Proceed&quot; button to make the payment online</font></h2>
	<form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <input type="hidden" name="txnid" value="<?php echo $txnid; ?>" />
        <input type="hidden" name="surl" value="<?= $BaseURL; ?>/Users/hostelsuccess.php"/> <!-- Success notification -->
	  <input type="hidden" name="furl" value="<?= $BaseURL; ?>/Users/hostelsuccess.php"/> <!-- Failure notification -->
